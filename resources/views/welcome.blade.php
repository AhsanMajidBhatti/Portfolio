        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>{{ $profile->birthdate }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>{{ $profile->phone }}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>{{ $profile->city }} , {{ $profile->country }}</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
